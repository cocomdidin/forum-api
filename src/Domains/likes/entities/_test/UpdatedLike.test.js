const UpdatedLike = require('../UpdatedLike');

describe('a UpdatedLike entities', () => {
  it('should throw error when payload did not contain needed property', () => {
    // Arrange
    const payload = {};

    // Action and Assert
    expect(() => new UpdatedLike(payload)).toThrowError('UPDATED_LIKE.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet data type specification', () => {
    ...
    // Action and Assert
    expect(() => new UpdatedLike(payload)).toThrowError('UPDATED_LIKE.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
  ...
  it('should create addLike object correctly', () => {
    ...
    // Action
    const addedLike = new UpdatedLike(payload);
